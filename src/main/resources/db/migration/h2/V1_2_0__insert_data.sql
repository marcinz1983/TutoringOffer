...
--SPECIALIZATION
Insert into SPECIALIZATION (SHORT_NAME,LONG_NAME,ICON_IMAGE,VERIFIED) VALUES ('WEB','Java,Spring,Hibernate','',true);
Insert into SPECIALIZATION (SHORT_NAME,LONG_NAME,ICON_IMAGE,VERIFIED) VALUES ('IOT','Ardunio,C,Embbeded','',true);
Insert into SPECIALIZATION (SHORT_NAME,LONG_NAME,ICON_IMAGE,VERIFIED) VALUES ('Mobile','Java,Android','',true);
Insert into SPECIALIZATION (SHORT_NAME,LONG_NAME,ICON_IMAGE,VERIFIED) VALUES ('Mobile','Swift,iOS','',true);
Insert into SPECIALIZATION (SHORT_NAME,LONG_NAME,ICON_IMAGE,VERIFIED) VALUES ('FRONDEND','HTML,CSS,JavaScript,React','',true);
Insert into SPECIALIZATION (SHORT_NAME,LONG_NAME,ICON_IMAGE,VERIFIED) VALUES ('WEB','HTML,CSS,JavaScript,PHP','',true);
