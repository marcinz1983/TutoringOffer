package com.anm.init.security.utils;
...
public class CookieUtils {
    ...
    @Autowired
    public CookieUtils(final HttpServletRequest httpServletRequest, final HttpServletResponse httpServletResponse, final SecurityProperties restSecProps) {
